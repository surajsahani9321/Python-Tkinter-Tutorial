...
parent.title("Suraj Sahani Calculator")
...
input_frame = Frame(parent, width=312, height=50, bd=0, highlightbackground="black", highlightcolor="black",
...
btns_frame = Frame(parent, width=312, height=272.5, bg="black")
btns_frame.pack()
...
zero = Button(btns_frame, text="0", fg="black", width=21, height=3, bd=0, bg="#fff", cursor="hand2",
              command=lambda: click(0)).grid(row=0, column=0, columnspan=2, padx=1, pady=1)
...
plus = Button(btns_frame, text="+", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
...
one = Button(btns_frame, text="1", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
             command=lambda: click(1)).grid(row=1, column=0, padx=1, pady=1)

two = Button(btns_frame, text="2", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
             command=lambda: click(2)).grid(row=1, column=1, padx=1, pady=1)

three = Button(btns_frame, text="3", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
               command=lambda: click(3)).grid(row=1, column=2, padx=1, pady=1)
...
seven = Button(btns_frame, text="7", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
               command=lambda: click(7)).grid(row=3, column=0, padx=1, pady=1)

eight = Button(btns_frame, text="8", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
               command=lambda: click(8)).grid(row=3, column=1, padx=1, pady=1)

nine = Button(btns_frame, text="9", fg="black", width=10, height=3, bd=0, bg="#fff", cursor="hand2",
              command=lambda: click(9)).grid(row=3, column=2, padx=1, pady=1)
...
clear = Button(btns_frame, text="Clear", fg="black", width=32, height=3, bd=0, bg="#fff", cursor="hand2",
               command=lambda: clear()).grid(row=4, column=0, columnspan=3, padx=1, pady=1)
